...
public class ScrollableView : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            movingTransform.localPosition += new Vector3(0, -Input.GetAxis("Mouse ScrollWheel") * sensitivity, 0);
        }
        ...
        {
            movingTransform.localPosition = new Vector3(0, Mathf.Max(((RectTransform)movingTransform).rect.height - ((RectTransform)transform).rect.height,0), 0);
